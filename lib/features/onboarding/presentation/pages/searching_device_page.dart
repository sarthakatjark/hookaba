    ...
    return BlocProvider<SignUpCubit>(
      ...
      child: BlocListener<SignUpCubit, SignUpState>(
        listenWhen: (previous, current) {
          ...
          final prevConnected = previous.pairedDevices.any((device) => previous.connectedDevices[device['name']] == true);
          final currConnected = current.pairedDevices.any((device) => current.connectedDevices[device['name']] == true);
            ...
            child: Padding(
              ...
              child: BlocBuilder<SignUpCubit, SignUpState>(
                builder: (context, SignUpState state) {
                  ...
                  final pairedDeviceNames = state.pairedDevices.map((d) => d['name']).toSet();
                  return Column(
                                ...
                                child: ListView.builder(
                                  ...
                                  itemCount: state.scannedDevices
                                      .where((device) =>
                                          ...
                                          !pairedDeviceNames.contains(device.platformName))
                                      .length,
                                  itemBuilder: (context, idx) {
